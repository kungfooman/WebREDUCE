...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 388496, 4), 388496);function _localtime_r(time, tmPtr) {
      _tzset();
...
var asmGlobalArg = {};
var asmLibraryArg = { "__clock_gettime": ___clock_gettime, "__map_file": ___map_file, "__sys_chdir": ___sys_chdir, "__sys_fcntl64": ___sys_fcntl64, "__sys_ftruncate64": ___sys_ftruncate64, "__sys_getcwd": ___sys_getcwd, "__sys_getdents64": ___sys_getdents64, "__sys_ioctl": ___sys_ioctl, "__sys_munmap": ___sys_munmap, "__sys_open": ___sys_open, "__sys_stat64": ___sys_stat64, "__sys_uname": ___sys_uname, "__sys_unlink": ___sys_unlink, "asctime": _asctime, "atexit": _atexit, "ctime": _ctime, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_longjmp": _emscripten_longjmp, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "getTempRet0": _getTempRet0, "gettimeofday": _gettimeofday, "invoke_d": invoke_d, "invoke_i": invoke_i, "invoke_ii": invoke_ii, "invoke_iidd": invoke_iidd, "invoke_iii": invoke_iii, "invoke_iiii": invoke_iiii, "invoke_iiiii": invoke_iiiii, "invoke_v": invoke_v, "invoke_vi": invoke_vi, "invoke_vii": invoke_vii, "invoke_viii": invoke_viii, "kill": _kill, "localtime": _localtime, "memory": wasmMemory, "setTempRet0": _setTempRet0, "siglongjmp": _siglongjmp, "signal": _signal, "strftime": _strftime, "system": _system, "table": wasmTable, "time": _time, "usleep": _usleep };
var asm = createWasm();
/** @type {function(...*):?} */
